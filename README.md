...
Easily generate a static site for your podcast feed, powered by the feed generated by [muxfm/glue](https://github.com/muxfm/glue).

[![Build site CI](https://github.com/muxfm/site/workflows/Build%20site/badge.svg)](https://github.com/muxfm/site/actions)

[**View example site →**](https://muxfm.github.io/site/)

## 💡 Getting started

1. Set up a repository [using this template](https://github.com/muxfm/site/generate) or fork this repository
...
```json
{
  "@staart/site": {
    ...
    "baseUrl": "https://muxfm.github.io/site",
    "listSubpages": true,
    ...
    "navbar": [
      "<a href='https://muxfm.github.io/site/episodes'>Episodes</a>",
      "<a href='https://muxfm.github.io/site/listen'>How to Listen</a>"
    ],
    "preFooter": [
      {
        "type": "message",
        ...
        "ctaText": "Listen now →",
        "ctaLink": "https://muxfm.github.io/site/listen"
      }
    ],
    "footer": {
      "text": "Hosted by Casey Neistat and Candice Pool",
      "links": [
        "<a href='https://muxfm.github.io/glue/feed.xml'>RSS</a>",
        "<a href='https://muxfm.github.io/glue/meta.xml'>API</a>"
      ]
    }
  },
  "bulwark": {
    "apiUrl": "https://muxfm.github.io/glue"
  }
}
```
